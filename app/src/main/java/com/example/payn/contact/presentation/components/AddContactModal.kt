                        ...
                        Row(
                            ...
                            Button(
                                ...
                                modifier = Modifier
                                    .weight(1f)
                                    .height(56.dp),
                                // Dark mode uses Gray900, light mode uses Gray200
                            ...
                            Button(
                                ...
                                shape = RoundedCornerShape(16.dp),
                                enabled = !isAdding && phoneNumber.isNotBlank()
                            ) {
                                if (isAdding) {
                                    ...
                                    Text("Add Contact", fontWeight = FontWeight.SemiBold, maxLines = 1, softWrap = false)
                                }
                            }
                        }
                    }
